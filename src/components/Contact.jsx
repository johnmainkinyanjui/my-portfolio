        ...
        <div className='flex flex-col p4 justify-center max-w-screen-lg mx-auto h-full'>
            <div className=' pb-8'>
                ...
                <div className='flex justify-center items-center'>
                    <form action="https://getform.io/f/494b181e-a580-4247-a8ad-238d623b0116" method='POST' className=' flex flex-col w-full md:w-1/2'>
                        ...
                        <textarea name="message" rows="5" className=' p-2 bg-transparent border-2 rounded-md text-white focus:outline-none'></textarea>
